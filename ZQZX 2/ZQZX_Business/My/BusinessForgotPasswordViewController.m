//
//  BusinessForgotPasswordViewController.m
//  ZQZX
//
...
#import "BusinessForgotPasswordNextVC.h"
#import "HttpRequest+MyBusiness.h"
#import "NetworkManager+Base.h"

@interface BusinessForgotPasswordViewController ()
...
@implementation BusinessForgotPasswordViewController
...
-(void)addUI{
    ...
    [_nextBtn addAction:^(UIButton *sender) {
        ...
        if (wf.phoneTextField.TextField.text.length <= 0 ) {
            ...
            [HttpRequest changeBusinessPhonemobile:wf.phoneTextField.TextField.text text:wf.verificationField.TextField.text Requestsuccess:^(HttpResponse * _Nonnull data, NSString * _Nonnull message) {
                [MBProgressHUD hideHUD];
                BusinessForgotPasswordNextVC *forgotPasswordNextVC = [[BusinessForgotPasswordNextVC alloc]init];
