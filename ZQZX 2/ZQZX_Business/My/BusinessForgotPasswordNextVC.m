//
//  BusinessForgotPasswordNextVC.m
//  ZQZX
//
...
@interface BusinessForgotPasswordNextVC ()
...
@implementation BusinessForgotPasswordNextVC
...
-(void)addUI{
    ...
    [_confirmBtn addAction:^(UIButton *sender) {
        ...
        [wf.phoneTextField.TextField resignFirstResponder];
        [wf.verificationField.TextField resignFirstResponder];
        if (self.phoneTextField.TextField.text.length <= 0 ) {
            ...
            [HttpRequest updatePasswordMobile:wf.phone newPassword:wf.phoneTextField.TextField.text Requestsuccess:^(HttpResponse * _Nonnull data, NSString * _Nonnull message) {
