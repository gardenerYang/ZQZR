...
#define COLOR_ARRAY @[\
[UIColor colorWithRed:252.0/255.0 green:150.0/255.0 blue:50.0/255.0 alpha:1],\
[UIColor colorWithRed:73.0/255.0 green:136.0/255.0 blue:242.0/255.0 alpha:1]/*,\
...
//        NSString *number = [NSString stringWithFormat:@"%.2f%%", model.rate * 100];
        ...
        NSString *orderNum = [NSString stringWithFormat:@"%@元",[self moneyStr:model.orderNum]] ;
        // 圆弧中心点的x值和y值
        CGFloat x = point.x;
        CGFloat y = point.y;
        ...
        // 指引线下面的title
        [orderNum drawInRect:CGRectMake(titleX, titleY, titleWidth, titleHeight) withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:9.0],NSForegroundColorAttributeName:color,NSParagraphStyleAttributeName:paragraph}];
...
-(NSString *)moneyStr:(CGFloat )money{
