...
- (void)setOnTintColor:(UIColor *)onTintColor
{
    if (_onTintColor != onTintColor) {
        ...
        if (_style == ZHSwitchStyleNoBorder) {
...
- (void)setStyle:(ZHSwitchStyle)style
{
    if (_style != style) {
        _style = style;
...
- (void)commonInit
{
    ...
    _borderView.layer.borderColor = _on ? _onTintColor.CGColor : _tintColor.CGColor;
    _borderView.hidden = (_style == ZHSwitchStyleNoBorder) ? YES : NO;
    [_containerView addSubview:_borderView];
    
    _onContentView = [[UIView alloc] initWithFrame:self.bounds];
    _onContentView.backgroundColor = (_style == ZHSwitchStyleNoBorder) ? _onTintColor : [UIColor clearColor];
    [_containerView addSubview:_onContentView];
    
    _offContentView = [[UIView alloc] initWithFrame:self.bounds];
    _offContentView.backgroundColor = (_style == ZHSwitchStyleNoBorder) ? _tintColor : [UIColor clearColor];
    ...
    _knobView.backgroundColor = (_style == ZHSwitchStyleNoBorder) ? _thumbTintColor : (_on ? _onTintColor : _tintColor);
