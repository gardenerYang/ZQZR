...
- (void)initCityPickerView{
    ...
    UIView *view =[[UIView alloc]initWithFrame:CGRectMake(0, 0, KScreenWidth, KScreenHeight-216)];
    ...
    [view addGestureRecognizer:singleRecognizer1];
    ...
    [btnSure setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
    ...
    _btnSelectShow.textColor = [UIColor whiteColor];
