...
//    [_imageview sd_setImageWithPreviousCachedImageWithURL:url placeholderImage:placeholder options:(0) progress:^(NSInteger receivedSize, NSInteger expectedSize) {
