...
@interface ProductListNegotiableVC ()<ZJJTimeCountDownDelegate>
...
@implementation ProductListNegotiableVC
...
-(void)requestList{
    ...
    [HttpRequest getHomeListPageNum:_page type:@"4" Requestsuccess:^(HomeListModel * _Nonnull model, NSString * _Nonnull message) {
