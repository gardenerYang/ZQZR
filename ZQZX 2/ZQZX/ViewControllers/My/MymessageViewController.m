...
@interface MymessageViewController ()<SRActionSheetDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        [cell.photoImg sd_setImageWithString:_myModel.headPortraitUrl];;
...

{
    ...
    if ([type isEqualToString:@"public.image"])
    {
        ...
        [[QNManage sharedInstance]qiuNiu:image token:self.qnModel.token url:self.qnModel.doman success:^(NSString * _Nonnull imgurl) {
            ...
            [HttpRequest uploadPhoto:imgurl Requestsuccess:^(HttpResponse * _Nonnull data, NSString * _Nonnull message) {
                NSLog(@"头像上传本地服务器成功");
            ...
            [MBProgressHUD showErrorMessage:@"头像更新失败"];
        }];
